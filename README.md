...
* The genetic algorithm can be separated and executed separately, only in GA_Algorithm.javaAdd the main function and input parameters following the example below:
    fdsfsdfds
